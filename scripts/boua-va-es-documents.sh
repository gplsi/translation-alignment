#!/bin/bash
#SBATCH --job-name=boua-va-es-documents               # Job name
#SBATCH --output=logs/boua-va-es-documents-[%j].out   # Standard output (stdout) file
#SBATCH --error=logs/boua-va-es-documents-[%j].err    # Standard error (stderr) file
