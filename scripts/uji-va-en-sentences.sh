#!/bin/bash
#SBATCH --job-name=uji-va-en-sentences                # Job name
#SBATCH --output=logs/uji-va-en-sentences-[%j].out    # Standard output (stdout) file
#SBATCH --error=logs/uji-va-en-sentences-[%j].err     # Standard error (stderr) file
