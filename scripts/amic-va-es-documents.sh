#!/bin/bash
#SBATCH --job-name=amic_paralelo-va-es-documents               # Job name
#SBATCH --output=logs/amic_paralelo-va-es-documents-[%j].out   # Standard output (stdout) file
#SBATCH --error=logs/amic_paralelo-va-es-documents-[%j].err    # Standard error (stderr) file
