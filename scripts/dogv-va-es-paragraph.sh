#!/bin/bash
#SBATCH --job-name=dogv-va-es-paragraphs               # Job name
#SBATCH --output=logs/dogv-va-es-paragraphs-[%j].out   # Standard output (stdout) file
#SBATCH --error=logs/dogv-va-es-paragraphs-[%j].err    # Standard error (stderr) file
